...
$arrReport = DailyReport::getAllfe(null);
                    ...
                    <tbody>
                      ...
                      ?>
                          <tr id="prod<?php echo $arrReport[$i]['id'] ?>">
                            ...
                            <td class="text-primary"> <?php echo $arrReport[$i]['zona']; ?></td>
                            <td class="text-primary"> <?php echo $arrReport[$i]['dtcreate']; ?></td>
                            <td><a href="daily_report_view_group1.php?hoa=<?php echo $arrReport[$i]['tbl_unidad_id']; ?>&place=<?php echo $arrReport[$i]['tec_lugar_id']; ?>&date=<?php echo $arrReport[$i]['dtcreate']; ?>" target="_blank" type="submit" title="Ver" rel="tooltip" class="btn btn-outline-primary btn-sm"><i class="fas fa-eye"></i></a>
