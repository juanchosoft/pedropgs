                        ...
                        <div class="offset-xl-2 col-xl-8 col-lg-12 col-md-12 col-sm-12 col-12">
                            <div class="card">
                                ...
                                <table class="table table-sm">
                                    ...
                                    <tr>
                                    <th class="red-background"><h5 class="red-background">Individual Floors</h5>   </th>  
                                    <td class="red-background"><h5 class="texto"></h5>   </td>
                                    <td class="red-background"><h5 class="texto"></h5>   </td>  
                                    <td class="red-background"><h5 class="texto"></h5>   </td>    
                                        <tr>                                       
                                        ...
                                        <tr> 
                                        <td class="red-background"><h5 class="texto">Trash Room Floor</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        ...
                                        <td class="red-background"><h5 class="texto">Maintenance Janitoral Room</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <td class="red-background"><h5 class="texto">Fire Control Panel Room</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <tr> 
                                        <td class="red-background"><h5 class="texto">Elevators</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <td class="red-background"><h5 class="texto">Water Pump Room</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <tr>                                       
                                        <td>IFree of hazardous material</td>
                                        <td><?php echo $materialp; ?></td>    
                                        </tr>
                                        <tr>                                       
                                        <td>IFire Extinguisher Charged</td>
                                        <td><?php echo $extinguisherp; ?></td>    
                                        </tr>

                                        <td class="red-background"><h5 class="texto">Disel Generator</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <td class="red-background"><h5 class="texto">Common Area A/C Units</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <tr> 
                                        <td class="red-background"><h5 class="texto">Trash Compactor Room</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  
                                        ...
                                        <tr> 
                                        <td class="red-background"><h5 class="texto">Roof</h5>   </td>  
                                        <td class="red-background"><h5 class="texto"></h5>   </td>  
                                        <tr>  

                                        <tr>  
                                        <td>No Standing Water</td>
                                        <td><?php echo $no_watere; ?></td>    
                                        </tr>
                                        <tr>  
                                        <td>Free of Debris</td>
